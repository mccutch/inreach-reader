...
import {
  ...
  UsernameInput,
  EmailInput,
} from "../components/validation.jsx";
...
export class RegistrationForm extends React.Component {
  ...
  setStrongPassword(bool) {
    this.setState({ strongPassword: bool });
  }
  setPasswordsMatch(bool) {
    this.setState({ passwordsMatch: bool });
  }
  setValidUsername(bool) {
    this.setState({ validUsername: bool });
  }
  setValidEmail(bool) {
  ...
  createProfile() {
    ...
    if (this.state.locationData || this.state.defaultLocationData) {
      let data = this.state.locationData
        ...
        : this.state.defaultLocationData;
  ...
  createProfileFailure(message) {
    this.returnError(
      "Error occurred while creating profile. Please try again."
    );
    ...
    let body = (
      <form>
        ...
        <small className="form-text text-muted">
          Location is optional improves your search results.
        </small>
        <p>
