...
export const PASSWORD_ERR =
  "Password must be 8-30 characters, including a capital letter and a number.";
export const PASSWORD_CHECK_ERR = "Passwords don't match.";
export const USERNAME_ERR =
  "Username must 6-30 alphanumeric characters, starting with a letter.";
  ...
  render() {
    return (
      <ValidatedInput
        ...
        placeholder={
          this.props.placeholder ? this.props.placeholder : "Username"
        }
  ...
  render() {
    return (
      <ValidatedInput
        ...
        returnValidation={this.props.returnValidation}
        validate={(input) => {
          return this.props.checkValue === input;
        }}
        placeholder={
          this.props.placeholder ? this.props.placeholder : "Confirm Password"
        }
      ...
      <div>
        <input
          ...
          onChange={(e) => {
            ...
            this.props.returnValidation(this.props.validate(e.target.value));
          }}
          placeholder={this.props.placeholder}
          maxLength={this.props.maxLength}
          className={`form-control ${this.props.className} ${
            this.props.isValid ? "is-valid" : ""
          } ${this.props.submitted && !this.props.isValid ? "is-invalid" : ""}`}
        />
        <small
          className={`${
            this.props.submitted ? "invalid-feedback" : "form-text text-muted"
          }`}
        >
          {this.props.value && !this.props.isValid
